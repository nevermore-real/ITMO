...
//    public ArrayDeque<Product> collection;
    ...
    public Response executeCommand(DatabaseHandler databaseHandler){

        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        PrintStream ps = new PrintStream(baos);
        PrintStream old = System.out;
        System.setOut(ps);
        manager.setCollection(databaseHandler.loadCollection());
        serverCommand.execute(databaseHandler);
        manager.setCollection(databaseHandler.loadCollection());
